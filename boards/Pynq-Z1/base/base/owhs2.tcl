...
user.org:user:design1:1.0\
xilinx.com:ip:mdm:3.2\
TomsHardwareDesign.com:onewire_library:ow_master_top:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set FS_0 [ create_bd_port -dir I -from 0 -to 0 FS_0 ]
  ...
  set in_ow [ create_bd_port -dir I in_ow ]
  set out_ow [ create_bd_port -dir O out_ow ]
  ...
  set rst_ow [ create_bd_port -dir I -type rst rst_ow ]
  ...
  # Create instance: design1_0, and set properties
  set design1_0 [ create_bd_cell -type ip -vlnv user.org:user:design1:1.0 design1_0 ]
  ...
  # Create instance: ow_master_top_0, and set properties
  set ow_master_top_0 [ create_bd_cell -type ip -vlnv TomsHardwareDesign.com:onewire_library:ow_master_top:1.0 ow_master_top_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.NUM_WRITE_OUTSTANDING {1} \
   CONFIG.MAX_BURST_LENGTH {1} \
 ] [get_bd_intf_pins /ow_master_top_0/ow_master_axi_interface]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M10_AXI [get_bd_intf_pins ow_master_top_0/ow_master_axi_interface] [get_bd_intf_pins ps7_0_axi_periph/M10_AXI]
  ...
  # Create port connections
  connect_bd_net -net Op2_0_1 [get_bd_ports FS_0] [get_bd_pins design1_0/FS]
  ...
  connect_bd_net -net design1_0_heater [get_bd_pins design1_0/heater] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net hdmi_out_hpd_video_gpio_io_o [get_bd_ports hdmi_out_hpd] [get_bd_pins video/hdmi_out_hpd]
  connect_bd_net -net i_data_0_1 [get_bd_ports in_ow] [get_bd_pins ow_master_top_0/i_data]
  connect_bd_net -net i_rst_0_1 [get_bd_ports rst_ow] [get_bd_pins ow_master_top_0/i_rst]
  ...
  connect_bd_net -net iop_pmodb_data_o [get_bd_pins iop_pmodb/data_o] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din]
  ...
  connect_bd_net -net ow_master_top_0_o_data [get_bd_ports out_ow] [get_bd_pins ow_master_top_0/o_data]
  ...
  connect_bd_net -net ps7_0_FCLK_CLK0 [get_bd_pins audio_direct_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins btns_gpio/s_axi_aclk] [get_bd_pins design1_0/clk] [get_bd_pins iop_arduino/clk_100M] [get_bd_pins iop_pmoda/clk_100M] [get_bd_pins iop_pmodb/clk_100M] [get_bd_pins leds_gpio/s_axi_aclk] [get_bd_pins ow_master_top_0/i_axi_aclk] [get_bd_pins ps7_0/FCLK_CLK0] [get_bd_pins ps7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0/S_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/M07_ACLK] [get_bd_pins ps7_0_axi_periph/M08_ACLK] [get_bd_pins ps7_0_axi_periph/M09_ACLK] [get_bd_pins ps7_0_axi_periph/M10_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rgbleds_gpio/s_axi_aclk] [get_bd_pins rst_ps7_0_fclk0/slowest_sync_clk] [get_bd_pins switches_gpio/s_axi_aclk] [get_bd_pins system_interrupts/s_axi_aclk] [get_bd_pins video/clk_100M]
  ...
  connect_bd_net -net rst_ps7_0_fclk0_peripheral_aresetn [get_bd_pins audio_direct_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins btns_gpio/s_axi_aresetn] [get_bd_pins iop_arduino/s_axi_aresetn] [get_bd_pins iop_pmoda/s_axi_aresetn] [get_bd_pins iop_pmodb/s_axi_aresetn] [get_bd_pins leds_gpio/s_axi_aresetn] [get_bd_pins ow_master_top_0/i_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/M08_ARESETN] [get_bd_pins ps7_0_axi_periph/M09_ARESETN] [get_bd_pins ps7_0_axi_periph/M10_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rgbleds_gpio/s_axi_aresetn] [get_bd_pins rst_ps7_0_fclk0/peripheral_aresetn] [get_bd_pins switches_gpio/s_axi_aresetn] [get_bd_pins system_interrupts/s_axi_aresetn] [get_bd_pins video/periph_resetn_clk100M]
  connect_bd_net -net rst_ps7_0_fclk0_peripheral_reset [get_bd_pins design1_0/reset] [get_bd_pins rst_ps7_0_fclk0/peripheral_reset]
  ...
  connect_bd_net -net xlconcat_0_dout [get_bd_ports pmodJB_data_out] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins design1_0/PWM] [get_bd_pins xlslice_0/Dout]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C80000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs ow_master_top_0/ow_master_axi_interface/Reg] SEG_ow_master_top_0_Reg
