...
HD_PWD='/home/bmull/PYNQ/boards/Pynq-Z1/base/base/base.runs/system_xlconcat_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_xlconcat_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_xlconcat_0_1.tcl
