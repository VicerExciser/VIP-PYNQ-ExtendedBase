...
HD_PWD='/home/bmull/PYNQ/boards/Pynq-Z1/base/base/base.runs/system_xlslice_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_xlslice_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_xlslice_1_0.tcl
