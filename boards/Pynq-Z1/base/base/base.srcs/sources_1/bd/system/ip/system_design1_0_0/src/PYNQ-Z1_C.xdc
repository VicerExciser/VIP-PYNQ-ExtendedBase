...
set_property -dict {PACKAGE_PIN M20 IOSTANDARD LVCMOS33} [get_ports FS]
...
set_property -dict {PACKAGE_PIN R14 IOSTANDARD LVCMOS33} [get_ports heater]
...
set_property -dict {PACKAGE_PIN D19 IOSTANDARD LVCMOS33} [get_ports PWM]
...
set_property MARK_DEBUG true [get_nets ps]
...
connect_debug_port u_ila_0/probe0 [get_nets [list ps]]
