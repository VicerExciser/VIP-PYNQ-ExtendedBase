...
proc create_root_design { parentCell } {
  ...
  set i_data_0 [ create_bd_port -dir I i_data_0 ]
  set o_data_0 [ create_bd_port -dir O o_data_0 ]
  ...
  # Create instance: ow_master_top_1, and set properties
  set ow_master_top_1 [ create_bd_cell -type ip -vlnv TomsHardwareDesign.com:onewire_library:ow_master_top:1.0 ow_master_top_1 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.NUM_WRITE_OUTSTANDING {1} \
   CONFIG.MAX_BURST_LENGTH {1} \
 ] [get_bd_intf_pins /ow_master_top_1/ow_master_axi_interface]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M10_AXI [get_bd_intf_pins ow_master_top_1/ow_master_axi_interface] [get_bd_intf_pins ps7_0_axi_periph/M10_AXI]
  ...
  connect_bd_net -net i_data_0_1 [get_bd_ports i_data_0] [get_bd_pins ow_master_top_1/i_data]
  ...
  connect_bd_net -net ow_master_top_1_o_data [get_bd_ports o_data_0] [get_bd_pins ow_master_top_1/o_data]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C80000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs ow_master_top_1/ow_master_axi_interface/Reg] SEG_ow_master_top_1_Reg
