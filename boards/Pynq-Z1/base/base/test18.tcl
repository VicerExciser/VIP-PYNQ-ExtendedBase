...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net Op2_0_1 [get_bd_ports FS_0] [get_bd_pins util_vector_logic_0/Op2]
